...
if (isset($_POST['username'])) {
	...
	$sql = "SELECT id, username, password, firstname, lastname FROM admin WHERE username = '$usname' AND activated = '1' LIMIT 1";
...
<div id="wrapper">
<h1>Login</h1>
<form id="form" action="indexadmin.php" method="post" enctype="multipart/form-data">
